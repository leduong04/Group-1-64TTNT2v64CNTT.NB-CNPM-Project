    ...
    <main>
        <div class="main_content">
            <div class="image-container">
                <div class="overlay">
                    <img class="mySlides" src="./../../../image/{{$service_details->img_link}}" alt="">
                </div>
                <div class="image-title" id="image-title">
                    <div class="img_name">
                        <p class="name_img">{{$service_details->name}}</p>
                        <p class="title_img"><a href="/">HOME</a> / <a href="{{route('user.service')}}">Service</a> / {{$service_details->name}}</p>
                    </div>
                    <div class="img_prize">
                        <p><span>{{ number_format($service_details->price, 0, ',', '.') }}</span> đ/lần</p>
                    </div>
                </div>
            </div>
            <div class="main-container">
                    ...
                    <div class="image_main">
                        <div class="image-left">
                            ...
                            <div class="thumbnail-container" id="thumbnail-container">
                                <img class="thumbnail" src="./../../../image/{{$service_details->img_link}}" alt="Thumbnail 1">
                            </div>
                        </div>
                ...
                <div class="other_room">
                    <div class="other_room_main">
                        <p class="other_name">Các Dịch Vụ Khác</p>
                        <div class="other" id="myContainer">
                            @foreach($other_service_details as $other_service_detail)
                            <div class="other_img">
                                <a href="{{route('user.service_detail',['id'=>$other_service_detail->id])}}">
                                    <img src="./../../../image/{{$other_service_detail->img_link}}" alt="">
                                    <p class="other_title">{{$other_service_detail->name}}</p>
                                    <p class="other_prize">{{ number_format($other_service_detail->price, 0, ',', '.') }}đ/lần</p>
                                </a>
                            </div>
                            @endforeach
                        </div>
